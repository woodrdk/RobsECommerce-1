...
{
    public class ProductsAutoController : Controller
    {
        ...
        // GET: ProductsAuto/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: ProductsAuto/Create
